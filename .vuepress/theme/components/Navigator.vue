		...
		<div class="relative mx-auto mt-8 sm:mt-12 mb-16 w-full max-w-xl">
			...
			<div class="border border-gray-300 shadow-xl rounded-lg">
				...
				<div class="bg-white border-t border-gray-300 rounded-b-lg p-4" @mouseleave="unfocus">
					...
					<div v-if="query && suggestions.length === 0" class="p-6 text-center text-gray-600" v-text="`No results...`"></div>
				</div>
			</div>
			<!-- Icons -->
			<div class="flex justify-center mt-5">
				...
				<!-- Github -->
				<a href="https://github.com/nagi1/" class="text-primary hover:text-black border-0 mx-2">
				...
				<!-- Facebook -->
				<a href="https://facebook.com/nagiwork" class="text-primary hover:text-blue-700 border-0 mx-2">
