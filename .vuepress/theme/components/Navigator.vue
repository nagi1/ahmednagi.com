		...
		<div class="relative mx-auto mt-8 sm:mt-20 mb-16 w-full max-w-xl">
			...
			<div class="hidden sm:grid grid-cols-3 gap-4 mb-8">
				<a
					...
					:key="tag.name"
					class="m-0 hover:bg-blackrock hover:no-underline hover:text-white px-4 py-2 rounded-lg border-0 shadow-lg"
					:class="tag.classes"
					:href="tag.path"
			...
			<div class="border border-gray-300 shadow-xl rounded-lg">
				...
				<div class="bg-white border-t border-gray-300 rounded-b-lg p-4" @mouseleave="unfocus">
					<a
						...
						class="flex px-4 py-2 text-lg font-semibold hover:no-underline text-gray-600 hover:text-gray-600 rounded cursor-pointer border-0"
					...
					>
						<Icon
							class="w-5 h-5 ltr:mr-3 rtl:ml-3 mt-1 flex-shrink-0"
							:icon="page.icon"
			...
			<div class="flex justify-center mt-5">
				<!-- Twitter -->
				<a href="https://twitter.com/lorismatic" class="text-primary hover:text-blue-500 border-0 mx-2">
				...
				<!-- Github -->
				<a href="https://github.com/lorisleiva" class="text-primary hover:text-black border-0 mx-2">
				...
				<!-- Dribbble -->
				<a href="https://dribbble.com/lorisleiva" class="text-primary hover:text-pink-500 border-0 mx-2">
					<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
						<path
