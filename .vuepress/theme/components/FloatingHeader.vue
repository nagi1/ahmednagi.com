<template>
    <div class="floating-header fixed w-full max-w-screen-xl mx-auto inset-x-0 top-0 pt-2 pb-3 sm:pt-3 sm:pb-5 shadow z-20" :class="{ 'active': isVisible }">
        <div class="container-lg">
            <div class="flex items-center">
                ...
                <div class="flex-1 flex items-center">
                    ...
                    <div 
                        v-text="$page.title" 
                        class="flex-1 text-lg font-serif font-medium ml-3 mr-4 w-5 h-8 truncate"
                    ></div>
                </div>
                ...
                <div class="hidden sm:flex items-center">
                    ...
                    <div class="ltr:ml-3 rtl:ml-2 uppercase tracking-wide text-sm font-semibold text-gray-600 mr-3">
                        share
                    </div>
                    <a 
                    ...
                    <a
                        class="mx-1 block border-0 leading-tight text-gray-600 hover:text-blue-600"
