	...
	<div class="xl:px-4" :class="{ 'theme-dark': dark }">
		...
		<div class="relative items-center hidden w-full max-w-screen-xl px-5 mx-auto overflow-hidden shadow-lg h-14 md:flex bg-primary xl:my-4 xl:rounded-lg">
			...
			<div class="flex justify-center ltr:ml-auto rtl:mr-auto">
				...
				<a href="https://facbook.com/nagiwork" class="mx-2 border-0 text-primary hover:text-blue-700">
		...
		<div class="relative w-full max-w-screen-xl mx-auto mt-4 overflow-hidden shadow-lg xl:my-6 xl:rounded-lg">
			<!-- Quick links -->
